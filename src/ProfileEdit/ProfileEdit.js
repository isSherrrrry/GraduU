    ...
    <form action="http://127.0.0.1:5000/edit/<username>" method="POST" encType="multipart/form-data" className="ui form profile_form_final">
      ...
      <section className="profile_grad profile_section">
        <label>
            ...
            <select name="edu_uni_name_1" className="ui selection dropdown">
                <option value={data.edu_uni_name_1} className="option">{data.edu_uni_name_1}</option>
            </select>
        </label>
        ...
        <label>
            ...
            <option>{data.edu_degree_1}</option>
        ...
        <label>
            ...
            value = {data.edu_major_1} onChange={handleChange}/></div>
        </label>

        <label>
            <span>Minor(s)</span>
            <div className="ui input"><input type="text" name='edu_minor_1'
            value = {data.edu_minor_1} onChange={handleChange}/></div>
        </label>
      </section>
      {
        ...
        <label>
            ...
            <select name="edu_uni_name_2" className="ui selection dropdown">
                <option value={data.edu_uni_name_2} className="option">{data.edu_uni_name_2}</option>
            </select>
        </label>
        ...
        <label>
            ...
            <option>{data.edu_degree_2}</option>
            <option value={"Associate Degree"}>Associate Degree</option>
            <option value={"Bachelor's Degree"}>Bachelor's Degree</option>
            <option value={"Master's Degree"}>Master’s Degree</option>
            <option value={"Doctoral Degree"}>Doctoral Degree</option>
        ...
        <label>
            ...
            value = {data.edu_major_2} onChange={handleChange}/></div>
        </label>

        <label>
            <span>Minor(s)</span>
            <div className="ui input"><input type="text" name='edu_minor_2'
            value = {data.edu_minor_2} onChange={handleChange}/></div>
        </label>
      </section>)
      }
      {
        ...
        <label>
            ...
            <select name="edu_uni_name_3" className="ui selection dropdown">
                <option value={data.edu_uni_name_3} className="option">{data.edu_uni_name_3}</option>
            </select>
        </label>
        ...
        <label>
            ...
            <option>{data.edu_degree_3}</option>
            <option value={"Associate Degree"}>Associate Degree</option>
            <option value={"Bachelor's Degree"}>Bachelor's Degree</option>
            <option value={"Master's Degree"}>Master’s Degree</option>
            <option value={"Doctoral Degree"}>Doctoral Degree</option>
        ...
        <label>
            ...
            value = {data.edu_major_3} onChange={handleChange}/></div>
        </label>

        <label>
            <span>Minor(s)</span>
            <div className="ui input"><input type="text" name='edu_minor_3'
            value = {data.edu_minor_3} onChange={handleChange}/></div>
        </label>
      </section>)
      }
      {
        ...
        <label>
            ...
            <select name="edu_uni_name_4" className="ui selection dropdown">
                <option value={data.edu_uni_name_4} className="option">{data.edu_uni_name_4}</option>
            </select>
        </label>
        ...
        <label>
            ...
            <option>{data.edu_degree_4}</option>
            <option value={"Associate Degree"}>Associate Degree</option>
            <option value={"Bachelor's Degree"}>Bachelor's Degree</option>
            <option value={"Master's Degree"}>Master’s Degree</option>
            <option value={"Doctoral Degree"}>Doctoral Degree</option>
        ...
        <label>
            ...
            value = {data.edu_major_4} onChange={handleChange}/></div>
        </label>

        <label>
            <span>Minor(s)</span>
            <div className="ui input"><input type="text" name='edu_minor_4'
            value = {data.edu_minor_4} onChange={handleChange}/></div>
        </label>
      </section>)
      }
      ...
      <section className="profile_Rec profile_section">
        <label className="textarea">
            ...
            <textarea type="text" name="rec" value = {data.rec} onChange={handleChange}/>
        </label>
      </section>
      ...
      <section className="profile_undergrad profile_section">
        <label>
            ...
            <select name="res_uni_1">
                <option value={data.res_uni_1}>{data.res_uni_1}</option>
            </select>
        </label>
        ...
        <label>
            ...
            value = {data.res_school_1} onChange = {handleChange}/>
        </label>

        <label>
            <span>Program Name</span>
            <input type="text" name="res_prog_1"
            value = {data.res_prog_1} onChange = {handleChange}/>
        </label>

        <label>
            <span>Funding</span>
            <select name="res_funding_1">
                <option>{data.res_funding_1}</option>
...

      {
        ...
        <label>
            ...
            <select name="res_uni_2">
                <option value={data.res_uni_2}>{data.res_uni_2}</option>
            </select>
        </label>
        ...
        <label>
            ...
            value={data.res_school_2} onChange={handleChange}/>
        </label>

        <label>
            <span>Program Name</span>
            <input type="text" name="res_prog_2"
            value={data.res_prog_2} onChange={handleChange}/>
        </label>

        <label>
            <span>Funding</span>
            <select name="res_funding_2">
                <option>{data.res_funding_2}</option>
                <option value={"No Funding"}>No Funding</option>
                <option value={"Partial Funding"}>Partial Funding</option>
                <option value={"Full Funding"}>Full Funding</option>
            </select>
...

      {
        ...
        <label>
            ...
            <select name="res_uni_3">
                <option value={data.res_uni_3}>{data.res_uni_3}</option>
            </select>
        </label>
        ...
        <label>
            ...
            value={data.res_school_3} onChange={handleChange}/>
        </label>

        <label>
            <span>Program Name</span>
            <input type="text" name="res_prog_3"
            value={data.res_prog_3} onChange={handleChange}/>
        </label>

        <label>
            <span>Funding</span>
            <select name="res_funding_3">
                <option>{data.res_funding_3}</option>
                <option value={"No Funding"}>No Funding</option>
                <option value={"Partial Funding"}>Partial Funding</option>
                <option value={"Full Funding"}>Full Funding</option>
            </select>
...

      {
        ...
        <label>
            ...
            <select name="res_uni_4">
                <option value={data.res_uni_4}>{data.res_uni_4}</option>
            </select>
        </label>
        ...
        <label>
            ...
            value={data.res_school_4} onChange={handleChange}/>
        </label>

        <label>
            <span>Program Name</span>
            <input type="text" name="res_prog_4"
            value={data.res_prog_4} onChange={handleChange}/>
        </label>

        <label>
            <span>Funding</span>
            <select name="res_funding_4">
                <option>{data.res_funding_4}</option>
                <option value={"No Funding"}>No Funding</option>
                <option value={"Partial Funding"}>Partial Funding</option>
                <option value={"Full Funding"}>Full Funding</option>
            </select>
...

      {
        ...
        <label>
            ...
            <select name="res_uni_5">
                <option value={data.res_uni_5}>{data.res_uni_5}</option>
            </select>
        </label>
        ...
        <label>
            ...
            value={data.res_school_5} onChange={handleChange}/>
        </label>

        <label>
            <span>Program Name</span>
            <input type="text" name="res_prog_5"
            value={data.res_prog_5} onChange={handleChange}/>
        </label>

        <label>
            <span>Funding</span>
            <select name="res_funding_5">
                <option>{data.res_funding_5}</option>
                <option value={"No Funding"}>No Funding</option>
                <option value={"Partial Funding"}>Partial Funding</option>
                <option value={"Full Funding"}>Full Funding</option>
            </select>
...

      {
        ...
        <label>
            ...
            <select name="res_uni_6">
                <option value={data.res_uni_6}>{data.res_uni_6}</option>
            </select>
        </label>
        ...
        <label>
            ...
            value={data.res_school_6} onChange={handleChange}/>
        </label>

        <label>
            <span>Program Name</span>
            <input type="text" name="res_prog_6"
            value={data.res_prog_6} onChange={handleChange}/>
        </label>

        <label>
            <span>Funding</span>
            <select name="res_funding_6">
                <option>{data.res_funding_6}</option>
                <option value={"No Funding"}>No Funding</option>
                <option value={"Partial Funding"}>Partial Funding</option>
                <option value={"Full Funding"}>Full Funding</option>
            </select>
...

      {
        ...
        <label>
            ...
            <select name="res_uni_7">
                <option value={data.res_uni_7}>{data.res_uni_7}</option>
            </select>
        </label>
        ...
        <label>
            ...
            value={data.res_school_7} onChange={handleChange}/>
        </label>

        <label>
            <span>Program Name</span>
            <input type="text" name="res_prog_7"
            value={data.res_prog_7} onChange={handleChange}/>
        </label>

        <label>
            <span>Funding</span>
            <select name="res_funding_7">
                <option>{data.res_funding_7}</option>
                <option value={"No Funding"}>No Funding</option>
                <option value={"Partial Funding"}>Partial Funding</option>
                <option value={"Full Funding"}>Full Funding</option>
            </select>
...

      {
        ...
        <label>
            ...
            <select name="res_uni_8">
                <option value={data.res_uni_8}>{data.res_uni_8}</option>
            </select>
        </label>
        ...
        <label>
            ...
            value={data.res_school_8} onChange={handleChange}/>
        </label>

        <label>
            <span>Program Name</span>
            <input type="text" name="res_prog_8"
            value={data.res_prog_8} onChange={handleChange}/>
        </label>

        <label>
            <span>Funding</span>
            <select name="res_funding_8">
                <option>{data.res_funding_8}</option>
                <option value={"No Funding"}>No Funding</option>
                <option value={"Partial Funding"}>Partial Funding</option>
                <option value={"Full Funding"}>Full Funding</option>
            </select>
...

      {
        ...
        <label>
            ...
            <select name="res_uni_9">
                <option value={data.res_uni_9}>{data.res_uni_9}</option>
            </select>
        </label>
        ...
        <label>
            ...
            value={data.res_school_9} onChange={handleChange}/>
        </label>

        <label>
            <span>Program Name</span>
            <input type="text" name="res_prog_9"
            value={data.res_prog_9} onChange={handleChange}/>
        </label>

        <label>
            <span>Funding</span>
            <select name="res_funding_9">
                <option>{data.res_funding_9}</option>
                <option value={"No Funding"}>No Funding</option>
                <option value={"Partial Funding"}>Partial Funding</option>
                <option value={"Full Funding"}>Full Funding</option>
            </select>
...

      {
        ...
        <label>
            ...
            <select name="res_uni_10">
                <option value={data.res_uni_10}>{data.res_uni_10}</option>
            </select>
        </label>
        ...
        <label>
            ...
            value={data.res_school_10} onChange={handleChange}/>
        </label>

        <label>
            <span>Program Name</span>
            <input type="text" name="res_prog_10"
            value={data.res_prog_10} onChange={handleChange}/>
        </label>

        <label>
            <span>Funding</span>
            <select name="res_funding_10">
                <option>{data.res_funding_10}</option>
                <option value={"No Funding"}>No Funding</option>
                <option value={"Partial Funding"}>Partial Funding</option>
                <option value={"Full Funding"}>Full Funding</option>
            </select>
...

      {
        ...
        <label>
            ...
            <select name="res_uni_11">
                <option value={data.res_uni_11}>{data.res_uni_11}</option>
            </select>
        </label>
        ...
        <label>
            ...
            value={data.res_prog_11} onChange={handleChange}/>
        </label>

        <label>
            <span>Funding</span>
            <select name="res_funding_11">
                <option>{data.res_funding_11}</option>
                <option value={"No Funding"}>No Funding</option>
                <option value={"Partial Funding"}>Partial Funding</option>
                <option value={"Full Funding"}>Full Funding</option>
            </select>
...

      {
        ...
        <label>
            ...
            <select name="res_uni_12">
                <option value={data.res_uni_12}>{data.res_uni_12}</option>
            </select>
        </label>
        ...
        <label>
            ...
            value={data.res_school_12} onChange={handleChange}/>
        </label>

        <label>
            <span>Program Name</span>
            <input type="text" name="res_prog_12"
            value={data.res_prog_12} onChange={handleChange}/>
        </label>

        <label>
            <span>Funding</span>
            <select name="res_funding_12">
                <option>{data.res_funding_12}</option>
                <option value={"No Funding"}>No Funding</option>
                <option value={"Partial Funding"}>Partial Funding</option>
                <option value={"Full Funding"}>Full Funding</option>
            </select>
      ...
      <section className="profile_undergrad profile_section">
        ...
        <label>
            ...
            <select name="demo_gender">
              <option>{data.demo_gender}</option>
        ...
        <label>
            ...
            <select name="demo_fistgen">
              <option>{data.demo_fistgen}</option>
        ...
        <label>
            ...
            <select name="demo_citizenship">
              <option>{data.demo_citizenship}</option>
